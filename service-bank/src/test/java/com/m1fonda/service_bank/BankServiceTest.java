...
//     private BankModel savedBankModel;
...
//         savedBankModel = BankModel.builder()
...
//         // Arrange
//         when(bankRepository.save(any(BankModel.class))).thenReturn(savedBankModel);
...
//         lenient().when(rabbitTemplate.convertSendAndReceive(
//             eq(RabbitMQConstants.AGENCY_EXCHANGE), 
//             eq(RabbitMQConstants.AGENCY_FIND_ALL_KEY)
//         )).thenReturn(mockAgencies);

//         BankModel bank = new BankModel(bankNumber, "bank name", "logo", "owner@email", "micro", 100000.0, "699999999");
...
//         // Arrange
//         String bankNumber = "12345678";
//         AgencyDTO agencyToUpdate = new AgencyDTO("3", "an agency 3", 10000, 0, 0, "updated address", bankNumber);
...
//         // Act
//         Boolean result = bankService.removeAgency(agencyToRemove);
...
//         // Arrange
//         AgencyDTO agencyToRemove = new AgencyDTO("5", "an agency 5", 9000, 10, 10, "remove address", "remove contact");
