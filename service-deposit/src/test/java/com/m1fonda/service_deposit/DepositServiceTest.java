...
// eq(AccountDTO.builder().balance(deposit.getAmount())
// .numAccount(deposit.getAccountNum())
// .numAgency(deposit.getAgencyNum())));
// }
...
// // Act
// List<DepositResponse> responses = depositService.filterDeposits("ACC123",
// "AGN001");
...
// // Act
// List<DepositResponse> responses = depositService.filterDeposits(null,
// "AGN001");
