...
// assertEquals(transferRequest.senderAccountNum(),
// response.senderAccountNum());
// assertEquals(transferRequest.receiverAccountNum(),
// response.receiverAccountNum());
...
// when(transferRepository.findBySenderAccountNumOrReceiverAccountNumAndAgencyNum("AGN001",
// "AGN001", "ACC_SENDER"))
// .thenReturn(mockTransfers);

// // Act
// List<TransferResponse> responses = transferService.filterTransfers("AGN001",
// "ACC_SENDER");
...
// transferService.filterTransfers("ACC_SENDER", null);
...
// // Act
// List<TransferResponse> responses = transferService.filterTransfers(null,
// "AGN001");
...
// // This test ensures the fallback method can be called without throwing an
// exception
